        ...
        <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 mb-10 md:mb-0">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="https://github.com/subtrack" className="bg-white text-gray-900 hover:bg-gray-200 px-6 py-3 rounded-lg text-lg font-semibold transition-colors">
                            <i className="fab fa-github mr-2"></i> View on GitHub
                        </a>
                        <a href="/docs" className="border-2 border-white hover:bg-white hover:bg-opacity-10 px-6 py-3 rounded-lg text-lg font-semibold transition-colors">
                            Documentation
                        </a>
                    </div>
                </div>
