...
export default function Settings() {
  ...
  const { register, handleSubmit, setValue, watch } = useForm({
    defaultValues: {
      ...
      reminderDays: currentUser?.reminderDays ?? 3,
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      setValue("emailNotifications", currentUser.emailNotifications ?? true);
      setValue("reminderDays", currentUser.reminderDays ?? 3);
    }
